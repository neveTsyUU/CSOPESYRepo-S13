...
void MainConsole::handleCommand(const std::string& input) {
    ...
    if (input == "exit") {
    ...
    else if (input == "vm-smi") {
        /*config->printConfig();*/
        pagingManager->vmStat();
        pagingManager->processSMI();
    }
    else if (input == "cpu-stat") {
        std::cout << "\n--- CPU Cycle Stats ---\n";
        std::cout << "Total CPU Cycles  : " << scheduler->getCpuCycles() << "\n";
        std::cout << "Active CPU Cycles : " << scheduler->getActiveCycles() << "\n";
        std::cout << "Idle CPU Cycles   : " << scheduler->getIdleCycles() << "\n\n";
    }
    else if (input == "print-sched") {
        pagingManager->printSmthFromScheduler();
        /*  std::cout << "CPU Cycles: " << pagingManager->printSmthFromScheduler() << std::endl << std::endl;*/
    }
    else if (input == "process-smi") {
        pagingManager->processSMI();
    }
    else if (input == "vm-stat") {
        pagingManager->vmStat();
    }
        ...
        std::cout << "| 'marquee'          -> Activates the marquee screen                                      |\n";
        ...
        std::cout << "| 'screen -s X Y'    -> Creates a new screen with name X allocating Y memory              |\n";
        std::cout << "| 'screen -c X Y Z'  -> Creates a new screen with name X allocating Y memory executing Z  |\n";
        ...
        std::cout << "| 'cpu-stat'         -> Shows total, active and idle CPU cycles                           |\n";
        std::cout << "| 'print-sched'      -> Prints something from the scheduler                               |\n";
        std::cout << "| 'process-smi'      -> Displays memory details in a high-detailed way                    |\n";
        std::cout << "| 'vm-stat'          -> Displays memory details in a fine-grained way                     |\n";
