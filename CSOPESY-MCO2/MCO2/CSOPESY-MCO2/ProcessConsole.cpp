...
void ProcessConsole::onEnabled() {
    ...
    std::cout << "Memory size: " << assignedProcess->getProcessMemorySize() << "\n";
    std::cout << "Frame size: " << assignedProcess->getProcessFrameSize() << "\n";
    std::cout << "Number of pages: " << assignedProcess->getNumberOfPages() << "\n";
...
bool ProcessConsole::isProcessStopped()
{
    return assignedProcess->isShutdown();
}

std::string ProcessConsole::getStopTime()
{
    return assignedProcess->getFormattedShutdownTime();
}

std::string ProcessConsole::getInvalidMemoryAddressAccess()
{
    return assignedProcess->getInvalidMemoryAddress();
}
...
void ProcessConsole::processSMI() const
{
    if (assignedProcess->isShutdown()) {
        ...
        std::cout << "Process stopped due to memory access violation. (" << assignedProcess->getInvalidMemoryAddress() << ")" << std::endl;
        std::cout << "=========================" << "\n\n";
    }
    else if (!assignedProcess->isFinished()) {
        std::cout << "\n";
        std::cout << "=========================" << "\n";
        std::cout << "Process: " << assignedProcess->getName() << "\n";
        std::cout << "ID: " << assignedProcess->getId() << "\n";
    ...
    /*assignedProcess->visualizeSymbolTable();*/ //SYMBOL TABALE VARIABLES
    /*assignedProcess->visualizeMemoryMap();*/  // MEMORY ADDRESSES OCCUPIED WITH VALUES
